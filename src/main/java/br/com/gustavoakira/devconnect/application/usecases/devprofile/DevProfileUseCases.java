...
public class DevProfileUseCases {
    ...
    public DevProfileUseCases(SaveDevProfileUseCase saveDevProfileUseCase, FindAllDevProfileUseCase findAllDevProfileUseCase, FindAllDevProfileWithFilterUseCase findAllDevProfileWithFilterUseCase, FindDevProfileByIdUseCase findDevProfileByIdUseCase, UpdateDevProfileUseCase updateDevProfileUseCase) {
