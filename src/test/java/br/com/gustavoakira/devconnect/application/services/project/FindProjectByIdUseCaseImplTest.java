...
class FindProjectByIdUseCaseImplTest {
    ...
    class Found{
        ...
        void setup() throws BusinessException, EntityNotFoundException {
            ...
            final DevProfile profile = new DevProfile(2L,"João Silva", "Desenvolvedor backend com 10 anos de experiência.", new Address("Rua A", "Cidade X", "Estado Y", "BR", "12345-678"), "https://github.com/joaosilva", "https://linkedin.com/in/joaosilva",new ArrayList<>());
